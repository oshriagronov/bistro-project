...
public class BistroClient extends AbstractClient {
	...
	public BistroClient(String host, int port, BistroController controller) throws IOException {
	...
	public void handleMessageFromServer(Object msg) {
		...
		if (msg instanceof ServerEvent se) {
			EventBus.getInstance().publish(se.getType());
			return;
		}

		if (msg instanceof BistroResponse response) {
			awaitResponse = false;
			controller.serverResponse(response);
			return;
		}
